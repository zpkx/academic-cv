...
这份在线简历背后是一个完整的工程系统：静态站点生成、双语国际化、自动化 PDF 导出、CI/CD 持续部署。我从想法到上线花了一天时间把它搭了起来。下面逐一拆解设计决策和技术实现。
...
一天时间从想法到上线，如果你对哪个技术细节感兴趣，欢迎通过 [GitHub](https://github.com/zpkx) 聊聊。